...
Current checkpoint: [bounded field repair and paid diagnostic](BOUNDED-REPAIR-PROOF-2026-09-10.md). The field-replacement contract preserves unchanged text/bindings; 2,339 tests, lint, typecheck and worker build passed at `3b41d97`. The paid retained-input diagnostic still blocked citation/word-growth changes inside edited fields, before final review or native article QA. Exact numeric repair guidance is the next correction. No successful automatic article, pilot reset, lander write or production action is claimed. Earlier checkpoints below are historical.
