...
Current checkpoint: [semantic FAQ preparation and live attempt](SEMANTIC-FAQ-PROOF-2026-09-10.md). The new preparation step passed with actual observed questions/body anchors; drafting and critique completed. The live run then failed because repair dropped required bindings and exceeded its edit/evidence scope. No accepted artifact or native article QA resulted. All 2,257 software tests pass; the next correction is field-level repair output. The complete live milestone remains unproven; earlier checkpoints below are historical.
