...
Current software checkpoint: [semantic FAQ preparation](SEMANTIC-FAQ-PROOF-2026-09-10.md). The worker selects observed questions with literal verified body anchors before drafting, retains the evidence receipt privately, and still requires independent critique/one repair/native QA. All 2,257 tests pass. A complete live article remains unproven; prior checkpoints below are historical, not current completion claims.
