...
Operator checkpoint on 2026-09-07: the [scope-alignment report](SCOPE-ALIGNMENT-PILOT-2026-09-07.md) is the current source of truth. The eighth attempt successfully collected organic/PAA evidence and four topical source bodies, then completed generation, critique, one repair and independent verification. Final checks rejected a copied passage and excessive source-derived prose, alongside checker false positives. No article was accepted or sent through live native QA. Follow-up software corrections are verified offline only. No generated lander PR, publication or schedule activation is authorized.

All prior failures remain in the history; the candidate is terminal at eight and there is no ninth-attempt path. The complete clean live milestone remains unproven; historical assisted articles, offline replays and synthetic fixtures are not substitutes. Do not reset the candidate to force another run. The [sixth-attempt report](SOURCE-DISCOVERY-PILOT-2026-09-07.md) records the earlier title-scope and citation failure and the fixes that followed it.
